...
description: Review code or a change through the "Delivery" lenses of the Software Design and Architecture Guidelines (Sections 12 to 16: apps, deployment, repo layout, client architecture, cross-cutting conventions). Use for a change that touches this area, or as one leg of arch-review-full.
