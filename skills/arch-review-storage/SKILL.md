...
description: Review code or a change through the "Storage" lenses of the Software Design and Architecture Guidelines (Section 8 and Identifiers: storage principles, tables, translation, roles, migrations). Use for a change that touches this area, or as one leg of arch-review-full.
