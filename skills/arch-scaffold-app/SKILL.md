...
| `src/client.ts`       | one transport client: the API origin taken from the app's config, bearer, app header, error envelope parsed into a typed error carrying the request id, 401 clears authentication |
