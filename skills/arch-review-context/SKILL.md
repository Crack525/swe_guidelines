...
description: "Review code or a change through the Context lenses of the Software Design and Architecture Guidelines. Covers OpContext, Separation of Layers, The Business Layer, The Storage Layer, The Network Layer, Worker Roles: OpContext, AdminContext, authorization, tenancy, provenance. Use for a change that touches this area, or as one leg of arch-review-full."
