...
description: Review code or a change through the "Network" lenses of the Software Design and Architecture Guidelines (Sections 10 and 12: topology, gateway, public types, clients, realtime, push-first). Use for a change that touches this area, or as one leg of arch-review-full.
