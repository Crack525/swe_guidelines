...
```text
/plugin marketplace add https://github.com/baristaze/swe_guidelines.git#v0.3.0
```
...
<https://github.com/baristaze/swe_guidelines/blob/v0.3.0/architecture.md>
(pinned at `v0.3.0`).
